export const apartments = [
  {
    id: 'minos-1st-floor',
    titleKey: 'apartmentsData.minos1stFloor.title',
    floorKey: 'apartmentsData.minos1stFloor.floor',
    capacity: 6,
    amenitiesKeys: [
      'apartmentsData.minos1stFloor.amenities.0',
      'apartmentsData.minos1stFloor.amenities.1'
    ],
    images: [
  ...
  {
    id: 'minos-white',
    titleKey: 'apartmentsData.minosWhite.title',
    floorKey: 'apartmentsData.minosWhite.floor',
    capacity: 2,
    amenitiesKeys: [
      'apartmentsData.minosWhite.amenities.0'
    ],
    images: [
  ...
  {
    id: 'minos-standard',
    titleKey: 'apartmentsData.minosStandard.title',
    floorKey: 'apartmentsData.minosStandard.floor',
    capacity: 2,
    amenitiesKeys: [
      'apartmentsData.minosStandard.amenities.0'
    ],
    images: [
  ...
  {
    id: 'minos-deluxe',
    titleKey: 'apartmentsData.minosDeluxe.title',
